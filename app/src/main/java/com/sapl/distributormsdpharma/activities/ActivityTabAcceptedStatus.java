...
public class ActivityTabAcceptedStatus extends AppCompatActivity {

    RecyclerView recyclerView = null;
    Context context = null;
    String LOG_TAG = "ActivityTabAcceptedStatus ";
    ...
    String statusId ="2", from_date="", to_date="";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tab_accepted_status);
        context = this;
    ...
    public void initComponantsListner(){
        img_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                View v1 = img_filter;
                PopupMenu popup = new PopupMenu(ActivityTabAcceptedStatus.this, v1);
    ...
    protected void onResume() {
        ...
        orderShopList = TABLE_RETAILER_ORDER_MASTER.getOrderStatusList(statusId, "calender" );
        initBindData(orderShopList);
        //orderShopList = TABLE_RETAILER_ORDER_MASTER.getOrderStatusList(statusId, "shop");  // BYDEFAULT FILTER SORT BY SHOP_NAME
        //initBindData(orderShopList);
    }
    ...
    public void showNoRecordsDialogue(String msg) {
        ...
        CustomButtonBold btn_ok = null, digHeader;
        ...
        tv_text.setText(msg);
        digHeader = (CustomButtonBold) dialog.findViewById(R.id.digHeader);
        digHeader.setText(getResources().getString(R.string.app_name));
