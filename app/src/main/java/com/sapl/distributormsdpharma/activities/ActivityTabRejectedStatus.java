...
public class ActivityTabRejectedStatus extends AppCompatActivity {

    RecyclerView recyclerView = null;
    Context context = null;
    String LOG_TAG = "ActivityTabRejectedStatus ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_rejected_status);
        context = this;
        initComponants();
    ...
    public void initComponantsListner(){
        img_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                View v1 = img_filter;
                PopupMenu popup = new PopupMenu(ActivityTabRejectedStatus.this, v1);
