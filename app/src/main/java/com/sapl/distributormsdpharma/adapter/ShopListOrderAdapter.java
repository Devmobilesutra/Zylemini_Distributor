...
public class ShopListOrderAdapter extends RecyclerView.Adapter<ShopListOrderAdapter.MyViewHolder> {
    String  LOG_TAG= "ShopListOrderAdapter ";
    private List<OrderDeliveryStatusModel> dastributorList;
    Context context;
    private final int CALL_REQUEST = 100;

    public ShopListOrderAdapter(Context context, List<OrderDeliveryStatusModel> dastributorList) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (pos != RecyclerView.NO_POSITION) {
                        ...
                        intent.putExtra("MOBILE_NO", mobNo+"" );
                        context.startActivity(intent);
                    }
                }
            });
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final OrderDeliveryStatusModel model = dastributorList.get(position);
       ...
       /* holder.img_name.clearAnimation();
        ...
        holder.txt_card_number.setText(model.getTotalQtys());
        MyApplication.logi("JARVIS","count is -->"+model.getTotalQtys());
